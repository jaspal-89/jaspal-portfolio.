  ...
  return (
    <section className="relative w-full py-20 px-4 overflow-hidden">
      ...
      >
        ...
        {/* Animated Ambience */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-red-900/20 blur-[120px] rounded-full animate-pulse z-0" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-red-950/20 blur-[100px] rounded-full z-0 opacity-50" />
        ...
        <div className="relative z-10 p-10 md:p-16 flex flex-col items-center text-center">
          ...
          <MagneticButton>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-red-100 to-white opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </a>
          </MagneticButton>
        </div>
      </m.div>
