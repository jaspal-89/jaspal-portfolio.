                    ...
                    <GlassmorphismCard className="p-4 md:p-6">
                        <div className="aspect-video relative rounded-lg overflow-hidden bg-gray-900">
                            {showVideo && embedUrl ? (
                                ...
                                <div className="relative w-full h-full flex items-center justify-center bg-gradient-to-br from-neutral-950 via-neutral-900 to-red-950/30">
                                    <div className="text-center px-6">
                                        <div className="mx-auto mb-4 w-16 h-16 rounded-full border border-red-400/30 bg-red-500/10 flex items-center justify-center">
                                            <Play className="text-red-300" size={24} />
                                        </div>
                                        <p className="text-[10px] uppercase tracking-[0.25em] text-gray-500">
                                            {embedUrl ? "Video Preview" : "Video URL Pending"}
                                        </p>
                                        {embedUrl && (
                                            <Button onClick={() => setShowVideo(true)} size="lg" className="mt-5 bg-white text-black hover:bg-gray-200 cursor-pointer">
                        ...
                        <GlassmorphismCard className="p-8">
                            ...
                            <div className="max-w-3xl mx-auto">
                                ...
                                <div className="relative">
                                    <Quote
                                        className="absolute -top-4 -left-4 text-red-400 opacity-50"
                                        size={32}
                                    />
